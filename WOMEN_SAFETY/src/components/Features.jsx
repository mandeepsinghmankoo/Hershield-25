...
function Features() {
    return (
        <>
            <div className="container flex flex-row gap-30 pl-12 ">
            ...
            <div className="section2 g-0 flex flex-col justify-between mt-20 mx-10">

                <div className='flex'>
                    <div className="vertical-line w-2 bg-[#B5A980] h-[500px]"></div>


                    <div className="features mt-5 ml-2">
                        ...
                        <div className="feature mb-8 flex gap-4">
                            ...
                            <div className='w-1/2 text-white'>
                                <h2 className="text-2xl font-bold text-[#394f6e]">Voice Triggered Alert</h2>
                                <p>Voice-Triggered Emergency Detection uses AI to detect distress calls or emergency keywords and instantly sends an SOS alert with the user's live location for rapid assistance.</p>
                            </div>
                        </div>
                ...
                <div classNmae='m-0 p-0'>
                    <div className='flex flex-row justify-end items-center'>

                        <img src="Voice.png" alt="" className='w-100 m-8' />
                        <div className="horiz w-90 h-1 bg-[#B5A980]"></div>

                        <img src="Gender.png" alt="" className='w-100' />
                        <div className="horiz w-40 h-1 bg-[#B5A980]"></div>

                        <div className="vertical-line w-2 bg-[#B5A980] h-[300]"></div>
                    </div>
                    <div className='flex flex-row justify-end items-center '>

                        <img src="SOS.png" alt="" className='w-100' />
                        <div className="horiz w-130 h-1 bg-[#B5A980]"></div>

                        <div className="vertical-line w-2 bg-[#B5A980] h-[300px]"></div>
                    </div>
                    <div className='flex flex-row justify-end items-center '>
                        <img src="GPS.png" alt="" className='w-110 p-7' />
                        <div className="horiz w-90 h-1 bg-[#B5A980]"></div>
                        
                        <img src="Lone.png" alt="" className='w-100' />
                        <div className="horiz w-30 h-1 bg-[#B5A980]"></div>
